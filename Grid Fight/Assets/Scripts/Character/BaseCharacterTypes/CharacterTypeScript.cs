...
public class CharacterTypeScript : BaseCharacter
{
    ...
    {
        if (CharInfo.StaminaStats.Stamina - CharInfo.StaminaStats.Stamina_Cost_S_Atk01 >= 0 && CharInfo.BaseCharacterType != BaseCharType.MinionTypeScript)
        {
