...
public class BattleManagerScript : MonoBehaviour
{
    ...
    public IEnumerator SetAllNonUsedCharOnBattlefield()
    {
        ...
        {
            bts = GridManagerScript.Instance.GetFreeTilesAdjacentTo(CurrentSelectedCharacters.Where(r=> r.Value.Character != null).First().Value.Character.UMS.CurrentTilePos, 2, true, WalkingSideType.LeftSide).First();
