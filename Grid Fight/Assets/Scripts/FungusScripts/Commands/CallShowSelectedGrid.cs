...
public class CallShowSelectedGrid : Command
{
    ...
    protected virtual void CallTheMethod()
    {
        ...
        StartCoroutine(EnvironmentManager.Instance.MoveToNewGrid(StageToShow, 0, new List<PlayersCurrentSelectedCharClass>(), new List<TalkingTeamClass>(), 1,false, false));
    }
