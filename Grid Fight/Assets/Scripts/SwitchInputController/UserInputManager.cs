...
public class UserInputManager : MonoBehaviour
{
    ...
    #region Joystick
    private void Instance_RightJoystickUsedEvent(int player, InputDirectionType dir, float value)
    {
    ...
    private void Instance_ButtonAUpEvent(int player)
    {
        ...
        SelectedCharacterStopWeakAttack(player);
    ...
    private void Instance_ButtonAPressedEvent(int player)
    {
        ...
        SelectedCharacterLoopWeakAttack(player);
    }
    ...
    private void Instance_ButtonZRDownEvent(int player)
    {
        ...
        {
            SelectedCharacterStartWeakAttack(player);
        }
        else if (BattleManagerScript.Instance.InputControllerT == InputControllerType.SelectionOnLR)
        {
    ...
    public void SelectedCharacterStartWeakAttack(int player)
    {
        BattleManagerScript.Instance.StartWeakAttack((ControllerType)player);
    }
    public void SelectedCharacterStopWeakAttack(int player)
    {
        BattleManagerScript.Instance.StopWeakAttack((ControllerType)player);
    }
    ...
    public void UserInputJoystickHandler(int player, InputDirectionType dir, float value)
    {
