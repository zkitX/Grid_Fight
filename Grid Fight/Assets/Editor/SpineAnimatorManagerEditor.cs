...
public class SpineAnimatorManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if(origin.Speed_Time_Curves.BackwardMovement == null)
        {
        ...
        if (origin.Space_Time_Curves.BackwardMovement == null)
        {
        ...
        if (origin.CurveType == MovementCurveType.Space_Time)
        {
            ...
            origin.Space_Time_Curves.ForwardMovement = EditorGUILayout.CurveField("ForwardMovementSpeed", origin.Space_Time_Curves.ForwardMovement);
            origin.Space_Time_Curves.BackwardMovement = EditorGUILayout.CurveField("BackwardMovementSpeed", origin.Space_Time_Curves.BackwardMovement);
        }
        else if (origin.CurveType == MovementCurveType.Speed_Time)
        {
            ...
            origin.Speed_Time_Curves.ForwardMovement = EditorGUILayout.CurveField("ForwardMovementSpeed", origin.Speed_Time_Curves.ForwardMovement);
            origin.Speed_Time_Curves.BackwardMovement = EditorGUILayout.CurveField("BackwardMovementSpeed", origin.Speed_Time_Curves.BackwardMovement);
        }
